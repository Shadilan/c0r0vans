    ...
    public String getInfo() {
        if (faction==0) {
            ...
            if (ready < 0)
                ...
                return "Засада ожидает здесь неосторожных караванщиков. По виду стоят уже " + (Math.round(ready / 60)) + " часов.";
            else if (ready / 60 / 24 > 2)
                return "Засада ожидает здесь неосторожных караванщиков. По виду стоят уже " + (Math.round(ready / 60 / 24)) + " дней.";
