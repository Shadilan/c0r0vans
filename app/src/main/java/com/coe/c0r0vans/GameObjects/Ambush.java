    ...
    private String getInfo() {
        if (faction==0) {
            ...
            if (ready < 0)
                ...
                return "Ваши соратники ждут здесь вражеских контрабандистов в Засаде. По виду стоят приблизительно " + (Math.round(ready / 60)) + " часов.";
            else if (ready / 60 / 24 > 2)
                return "Ваши соратники ждут здесь вражеских контрабандистов в Засаде. По виду стоят приблизительно " + (Math.round(ready / 60 / 24)) + " дней.";
            ...
            if (ready < 0)
                ...
                return "Засада ожидает здесь неосторожных караванщиков. По виду стоят приблизительно " + (Math.round(ready / 60)) + " часов.";
            else if (ready / 60 / 24 > 2)
                return "Засада ожидает здесь неосторожных караванщиков. По виду стоят приблизительно " + (Math.round(ready / 60 / 24)) + " дней.";
